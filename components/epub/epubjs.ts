      ...
      const n = "0.3",
        ...
        s = {
          ...
          CONTENTS: {
            ...
            SENTENCE_SELECTED: "sentenceSelected", 
            SENTENCE_SELECTED_RANGE: "sentenceSelectedRange",
        ...
        onSelectionChange(t) {
          ...
          (this.selectionEndTimeout = setTimeout(
            function () {
              ...
              if (t && t.rangeCount > 0) {
                let range = t.getRangeAt(0);
                if (!range.collapsed) {
                  let sentenceRange = this.selectSentence(range);
                  if (sentenceRange) {
    ...
    function (t, e, i) {
      ...
      class b {
        ...
        passEvents(t) {
          ...
          // Add sentence selection
          t.on(l.c.CONTENTS.SENTENCE_SELECTED, (e) => this.triggerSentenceSelectedEvent(e, t));
        }

        triggerSentenceSelectedEvent(t, e) {
          // Re-emit as a RENDITION sentence selection event
          this.emit(l.c.RENDITION.SENTENCE_SELECTED, t, e);
        }
